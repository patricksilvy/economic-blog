...
export default function Contact({ siteconfig }) {
  ...
  const apiKey = siteconfig?.w3ckey || "rt6f95ah";
        ...
        <div className="grid my-10 md:grid-cols-2">
          <div className="my-10">
            ...
            <p className="max-w-sm mt-5">
              Tem algo a dizer? Estamos aqui para ajudar. 
              Preencha o formulário ou envie email ou telefone.
            </p>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="my-10">
              ...
              <div className="mb-5">
                <input
                  ...
                  {...register("name", {
                    required: "Nome completo é um requisito",
                    maxLength: 80
                  })}
                />
                {errors.name && (
